...
export default async function VariantsPage({
  ...
  params: { websiteId: string; elementId: string };
}) {
  ...
  const breadcrumbLinks = [
    ...
    { title: element.website.name, href: `/dashboard/websites/${params.websiteId}` },
    { title: "Elements", href: `/dashboard/websites/${params.websiteId}/elements` },
    { title: element.name, href: `/dashboard/websites/${params.websiteId}/elements/${params.elementId}` },
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      >
        <Link href={`/dashboard/websites/${params.websiteId}/elements/${params.elementId}/variants/new`}>
          <Button>
      ...
      <div className="mt-8">
        <Suspense fallback={<LoadingSpinner />}>
          <VariantsList elementId={params.elementId} websiteId={params.websiteId} />
        </Suspense>
      </div>
    </div>
  );
